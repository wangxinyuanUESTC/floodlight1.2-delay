...
//	private static final Logger log2 = LoggerFactory.getLogger(OFChannelHandler.class);
...
//volatile相当与同步块
    ...
    public  static  long strTime;
    public static double endTime1;
    public static double strTime1;
	/**
...
//			writer=new FileWriter("/home/wxy/floodlight-1.222/QoS/outputdelay.txt",true);

//			writer.write("**EchoRequest的Xid："+factory.buildEchoRequest().getXid()+"请求时间："+echoSendTime+"  "
//					+"**EchoReplay的Xid："+factory.buildEchoReply().getXid()+"收到响应时间："+System.currentTimeMillis()+"\n");
		
		
			/*
		 *  有一个问题就是怎么把发送echorequest的地址传过来
		 */
//			writer.flush();
//			writer.close();
	...
	private void sendEchoRequest() {
		...
		strTime1=Time.time();
//		log.info("》》》》》》》》》》》》》》》》EchoRequest-xid :  "+request.getXid() +"  EchoRequest时间戳:"+System.currentTimeMillis());
//         log.info("Time.time:"+decimalFormat.format(strTime));
		write(request);	
